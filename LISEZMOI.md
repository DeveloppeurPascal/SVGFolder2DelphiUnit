...
>
> La maintenance de ce projet est déplacée vers Codeberg sur https://codeberg.org/PatrickPremartin/SVGFolder2DelphiUnit
>
...
> [!NOTE]
> Pour ouvrir ou intervenir sur un ticket de ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/SVGFolder2DelphiUnit/issues
> Pour faire un PULL REQUEST sur ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/SVGFolder2DelphiUnit/pulls
> Pour toute autre information ou me contacter vous pouvez aussi consulter le site Internet du projet sur https://svgfolder2delphiunit.olfsoftware.fr ou son devlog sur https://svgfolder2delphiunit.olfsoftware.fr/dev-corner.html
...
Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://github.com/DeveloppeurPascal/SVGFolder2DelphiUnit).
...
L'export de la documentation est fait en HTML par [DocInsight](https://devjetsoftware.com/products/documentation-insight/) ou [PasDoc](https://pasdoc.github.io) vers le dossier /docs du dépôt. Vous y avez aussi [accès en ligne](https://developpeurpascal.github.io/SVGFolder2DelphiUnit) grâce à l'hébergement offert par GitHub Pages.

D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://svgfolder2delphiunit.olfsoftware.fr) ou [le devlog du projet](https://developpeur-pascal.fr/svg-folder-to-delphi-unit.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/SVGFolder2DelphiUnit/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si cette licence ne convient pas à vos besoins (notamment pour un projet commercial) je propose aussi [des licences classiques pour les développeurs et les entreprises](https://svgfolder2delphiunit.olfsoftware.fr).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/SVGFolder2DelphiUnit) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/SVGFolder2DelphiUnit/issues).
